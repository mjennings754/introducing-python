"""
8.1 Make an English-to-French dictionary called e2f and print it. Here are
...
"""
8.2 Using your three-word dictionary e2f, print the French word for
walrus
"""
print(e2f['walrus'])

"""
8.3 Make a French-to-English dictionary called f2e from e2f. Use the
items method.
"""
f2e = {}
...
topmost keys: 'animals'
,
'plants', and 'other'. Make the 'animals'
...
"""
8.12 Use a generator comprehension to return the string 'Got ' and a
